...
formations = [
    ...
    {
        # A formation
	'drone_0': (1.23, 3.88, 0.78, 0.0),
	'drone_1': (1.43, 3.85, 1.21, 0.0),
	'drone_2': (1.62, 3.82, 1.58, 0.0),
	'drone_3': (2.38, 3.92, 0.78, 0.0),
	'drone_4': (2.21, 3.88, 1.19, 0.0),
	'drone_5': (2.03, 3.82, 1.58, 0.0),
	'drone_6': (1.82, 3.76, 1.96, 0.0),
    ...
    {
        # V formation
        'drone_0': (1.23, 3.2, 1.97, 0.0),
        'drone_1': (1.43, 3.21, 1.56, 0.0),
        'drone_2': (1.62, 3.21, 1.16, 0.0),
        'drone_3': (2.38, 3.19, 1.97, 0.0),
        'drone_4': (2.21, 3.2, 1.56, 0.0),
        'drone_5': (2.03, 3.21, 1.15, 0.0),
        'drone_6': (1.84, 3.22, 0.77, 0.0),
